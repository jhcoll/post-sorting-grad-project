...
class AndCombineFiltersTest {
    ...
    void filter_null_null() {
        ...
        List<UserPost> actual = new AndCombineFilters(localAuthorPostFilter, localDatePostFilter).filter(null);
    ...
    void filter_1ItemListMatchBoth_1ItemList() {
        ...
        when(localDatePostFilter.filter(List.of(userPostJane))).thenReturn(List.of(userPostJane));
    ...
    void filter_1Item1Match_EmptyList() {
        ...
        when(localAuthorPostFilter.filter(inputList)).thenReturn(List.of(userPostJane));
        when(localDatePostFilter.filter(List.of(userPostJane))).thenReturn(List.of());
    ...
    @Test
    void combine_3Items1Match_1ItemList() {
